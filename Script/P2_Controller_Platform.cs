...
public class P2_Controller_Platform : MonoBehaviour
{
	...
	private void Start()
	{
		...
		hpBar = GameObject.FindObjectOfType<P2_HPBarAnim>();
	...
	void Block()
	{
		...
		if (isBlocking && Time.time - blockStartTime >= 30f && !isstrongdamage)
		{
	...
	public IEnumerator DisableBlockInput()
	{
		...
		anim.SetBool("Block", false);
		//yield return new WaitForSeconds(1f); // 1秒間入力を受け付けない
